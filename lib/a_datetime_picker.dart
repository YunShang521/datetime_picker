library a_datetime_picker;

import 'dart:async';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/painting.dart';
import 'package:a_datetime_picker/src/datetime_picker_theme.dart';
import 'package:a_datetime_picker/src/date_model.dart';
import 'package:a_datetime_picker/src/i18n_model.dart';

export 'package:a_datetime_picker/src/datetime_picker_theme.dart';
export 'package:a_datetime_picker/src/date_model.dart';
export 'package:a_datetime_picker/src/i18n_model.dart';
      ...
      child: Container(
        ...
        child: NotificationListener(
          ...
          child: CupertinoPicker.builder(
            key: key,
            squeeze: widget.squeeze != null ? widget.squeeze! : 1.1,
            diameterRatio:
                widget.diameterRatio != null ? widget.diameterRatio! : 1.45,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    height: 1,
                    // width: 10,
                    decoration: BoxDecoration(color: Color(0xFFE2E4EA)),
                  ),
                  Container(
                    height: 1,
                    // width: 10,
            ...
            child: Row(
                ...
                children: <Widget>[
                  ...
                  widget.pickerModel.leftDivider() != ""
                      ? Container(
                          padding: EdgeInsets.only(left: 8, right: 8),
                          child: Text(widget.pickerModel.leftDivider(),
                              style: theme.itemStyle))
                      : Container(),
                  Container(
                  ...
                  widget.pickerModel.rightDivider() != ""
                      ? Container(
                          padding: EdgeInsets.only(left: 8, right: 8),
                          child: Text(widget.pickerModel.rightDivider(),
                              style: theme.itemStyle))
                      : Container(),
                  Container(
